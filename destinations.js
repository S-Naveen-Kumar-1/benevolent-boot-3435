let arr=[
    ...
    },
    {
        ...
        price:6000,
        details:"Konark Sun Temple is a 13th-century CE (year 1250) Sun temple at Konark about 35 kilometres (22 mi) northeast from Puri city on the coastline in Puri district, Odisha, India. The temple is attributed to king Narasimhadeva I of the Eastern Ganga dynasty about 1250 CE.",
        img:"https://upload.wikimedia.org/wikipedia/commons/thumb/b/b8/Konark_Sun_Temple_Front_view.jpg/800px-Konark_Sun_Temple_Front_view.jpg"
    },
    {
        place:"Sikkim",
        price:7500,
...
data.map(function(e){
    ...
    buy.addEventListener("click",function(){
        for(let i=0;i<buypackage.length;i++){
            if(buypackage[i].id===e.id){
                return alert("Package Already in Checkout Page, Please Go to Checkout Page")
            }
        }
        e.quantity=1;
        buypackage.push(e)
